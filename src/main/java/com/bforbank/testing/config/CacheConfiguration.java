package com.bforbank.testing.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.bforbank.testing.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.bforbank.testing.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
